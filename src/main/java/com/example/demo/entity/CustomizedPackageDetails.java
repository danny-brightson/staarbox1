...
public class CustomizedPackageDetails {
	...
	public CustomizedPackageDetails(Integer id, Integer customerId, LocalDateTime customizedDate, Byte weekdaysId,
			Boolean isEggAdded, String eggOrSeed, Integer fruit1Id, String fruit1Weight, Integer fruit2Id,
