...
@Entity
@Table(name = "PremiumPackDetails")
@Where(clause = "StatusId = 1")
public class PremiumPackDetails {
	...
	public String toString() {
		return "PremiumPackDetails [id=" + id + ", ingredients=" + ingredients + ", statusId=" + statusId
				+ ", createdBy=" + createdBy + ", createdTime=" + createdTime + ", modefiedBy=" + modefiedBy
				+ ", modefiedTime=" + modefiedTime + "]";
	}

	public PremiumPackDetails(Long id, String ingredients, Long statusId, String createdBy, LocalDateTime createdTime,
