...
@Entity
@Table(name = "standardpackdetails")
@Where(clause = "StatusId = 1")
public class StandardPackDetails {
		...
		@Column(name = "Fruit4", nullable = false)
		private String fruit4;

		@Column(name = "Fruit4Weight", nullable = false)
		...
		public StandardPackDetails() {
		}

		// ---------- Getters and Setters ----------

		public StandardPackDetails(Integer id, Byte weekdaysId, Integer isEggAdded, String eggOrSeed, String fruit1,
				String fruit1Weight, String fruit2, String fruit2Weight, String fruit3, String fruit3Weight,
				String fruit4, String fruit4Weight, String nut1, String nut1Weight, String nut2, String nut2Weight,
				String nut3, String nut3Weight, String nut4, String nut4Weight, String optional1,
				String optional1Weight, String optional2, String optional2Weight, String optional3,
				String optional3Weight, Long statusId, String createdBy, LocalDateTime createdTime, String modifiedBy,
