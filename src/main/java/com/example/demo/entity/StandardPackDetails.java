...
public class StandardPackDetails {
	...
	public StandardPackDetails(Long id, String ingredients, Long statusId, String createdBy, LocalDateTime createdTime,
	...
	public String toString() {
		return "StandardPackDetails [id=" + id + ", ingredients=" + ingredients + ", statusId=" + statusId
				+ ", createdBy=" + createdBy + ", createdTime=" + createdTime + ", modefiedBy=" + modefiedBy
