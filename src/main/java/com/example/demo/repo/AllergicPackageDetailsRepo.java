...
import com.example.demo.entity.AllergicPackageDetails;

@Repository
public interface AllergicPackageDetailsRepo extends JpaRepository<AllergicPackageDetails, Long>{
	    ...
	    @Query(value = """
	        ...
	        WHERE p.CustomerId = :customerId AND p.WeekdaysId = :weekdayId 
	    """, nativeQuery = true)
